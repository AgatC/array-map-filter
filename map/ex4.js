...
function getCirclesProperties(radiuses) {
  const calcul = radiuses.map(function (rayons) {
    return 'radius : ', radiuses.rayons, 'circumference: ', (2 * Math.Pi * radiuses.rayons), 'surface: ', (Math.Pi * radiuses.rayons * radiuses.rayons);
  });
}
